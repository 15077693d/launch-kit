...
CREATE TABLE "launch-kit_post" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "launch-kit_post_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar(256),
...
ALTER TABLE "launch-kit_post" ADD CONSTRAINT "launch-kit_post_createdById_launch-kit_user_id_fk" FOREIGN KEY ("createdById") REFERENCES "public"."launch-kit_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "created_by_idx" ON "launch-kit_post" USING btree ("createdById");--> statement-breakpoint
CREATE INDEX "name_idx" ON "launch-kit_post" USING btree ("name");--> statement-breakpoint
